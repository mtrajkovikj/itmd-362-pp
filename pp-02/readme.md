...
some operating systems, you might be able to customize the shortcuts to your own liking): Start button + Tab (to open Task View), then Start button + Ctrl + Left arrow or Start button + Ctrl + Right arrow to switch between views.
